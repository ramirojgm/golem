...
gpointer
golem_invoke_boxed(gpointer address,GolemArgs * args);

GObject *
golem_invoke_gobject(gpointer address,GolemArgs * args);

gchar *
golem_invoke_string(gpointer address,GolemArgs * args);
