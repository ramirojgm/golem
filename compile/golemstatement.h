...
#define	GOLEM_DEFINE_STATEMENT(N,n)  static void n##_init(N * statement);\
				     ...
				     static gboolean n##_compile (N* statement,\
								  ...
								  GError ** error);\
				     static GolemMetadata * n##_value_type (N* statement,\
								  GolemScopeBuilder * scope_builder,\
								  GError ** error);\
...
typedef GolemMetadata* (*GolemStatementValueType)(GolemStatement * statement,
					  GolemScopeBuilder * scope_builder,
					  GError ** error);
...
GolemMetadata*	 golem_statement_value_type(GolemStatement * statement,
					    GolemScopeBuilder * scope_builder,
					    GError ** error);
